...
public class ProductSalesViewModel extends ViewModel {
    ...
    public Completable addQuantityToStock(Context context, ItemRequest itemRequest) {
        return NetworkClient.getNetworkInterface()
                .addQuantityToStock(SharedPreferencesUtils.retrieveToken(context), itemRequest)
                .subscribeOn(Schedulers.io());
    }
